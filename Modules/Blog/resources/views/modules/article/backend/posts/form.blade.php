...
<div class="row">
    <div class="col-4">
        <div class="form-group">
            ...
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
            {{ html()->select($field_name, isset($$module_name_singular)?$$module_name_singular->$field_relation?->pluck('name', 'id'):'')->placeholder($field_placeholder)->class('form-control select2-category')->attributes(["$required"]) }}
        </div>
    </div>
    <div class="col-4">
        <div class="form-group">
    ...
    <div class="col">
        <div class="form-group">
            ...
            {{ html()->multiselect($field_name,
                isset($$module_name_singular)?$$module_name_singular->$field_relation?->pluck('name', 'id'):'',
                isset($$module_name_singular)?$$module_name_singular->$field_relation?->pluck('id')->toArray():''
