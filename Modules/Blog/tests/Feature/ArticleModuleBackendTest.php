...
class ArticleModuleBackendTest extends TestCase
{
     ...
     * @test
     */
    public function general_user_redirects_to_login_at_posts_list(): void
    {
     ...
     * @test
     */
    public function super_admin_can_access_posts_list(): void
    {
     ...
     * @test
     */
    public function general_user_redirects_to_login_at_categories_list(): void
    {
     ...
     * @test
     */
    public function super_admin_can_access_categories_list(): void
    {
        $this->loginAsSuperAdmin();
     ...
     * @test
     */
    public function general_user_redirects_to_login_at_tags_list(): void
    {
     ...
     * @test
     */
    public function super_admin_can_access_tags_list(): void
    {
        $this->loginAsSuperAdmin();
     ...
     * @test
     */
    public function general_user_redirects_to_login_at_comments_list(): void
    {
     ...
     * @test
     */
    public function super_admin_can_access_comments_list(): void
    {
        $this->loginAsSuperAdmin();
