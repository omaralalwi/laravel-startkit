...
class BackendTest extends TestCase
{
     ...
     * @test
     */
    public function super_admin_can_access_backups(): void
    {
        $this->loginAsSuperAdmin();
     ...
     * @test
     */
    public function super_admin_can_access_roles(): void
    {
        $this->loginAsSuperAdmin();
     ...
     * @test
     */
    public function super_admin_can_access_logs_dashboard(): void
    {
        $this->loginAsSuperAdmin();
     ...
     * @test
     */
    public function super_admin_can_access_logs_list(): void
    {
        $this->loginAsSuperAdmin();
     ...
     * @test
     */
    public function super_admin_can_access_notifications(): void
    {
        $this->loginAsSuperAdmin();
