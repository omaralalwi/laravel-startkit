...
Route::prefix('admin')->name('backend.')->middleware('auth', 'can:view_backend')->group(function () {

    /**
     * Backend Dashboard
     * Namespaces indicate folder structure.
     */
    Route::get('/', [Backend\BackendController::class, 'index'])->name('home');
    Route::get('dashboard', [Backend\BackendController::class, 'index'])->name('dashboard');
    ...
    */
    ...
    Route::resource("$module_name", "$controller_name");
    Route::patch("$module_name/{id}/block", ['as' => "$module_name.block", 'uses' => "$controller_name@block"]);
    Route::patch("$module_name/{id}/unblock", ['as' => "$module_name.unblock", 'uses' => "$controller_name@unblock"]);
});
